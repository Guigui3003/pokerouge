...
ENDC
	...
	RGB 31,31,31, 29,25,15, 29,09,13, 00,00,00 ; PAL_EXP (only used when GEN_2_GRAPHICS is set)
...
; TYPES
	RGB 31,31,31, 31,31,10, 30,14,06, 20,01,01 ; PAL_FIRE
; MOVES	
	RGB 31,31,31, 00,26,26, 31,31,00, 30,00,24 ; PAL_AURORA
	RGB 31,31,31, 29,30,31, 24,28,30, 18,26,30 ; PAL_BUBBLE
	RGB 31,31,31, 18,28,26, 22,20,28, 30,00,30 ; PAL_DRAGON_RAGE
	RGB 31,31,31, 30,20,26, 30,00,24, 14,06,24 ; PAL_PSYBEAM
	RGB 31,31,31, 28,28,20, 24,24,16, 20,20,12 ; PAL_SAND_ATTACK
	
; The following are only available with gen 2 graphics patch: individual palettes for
; pokemon, trainers, etc.

IF GEN_2_GRAPHICS
	RGB 31,31,31, 16,24,22, 05,18,10, 00,00,00 ; PAL_BULBASAUR
	RGB 31,31,31, 16,24,22, 28,10,12, 00,00,00 ; PAL_IVYSAUR
	RGB 31,31,31, 16,24,22, 31,14,16, 00,00,00 ; PAL_VENUSAUR
	RGB 31,31,31, 31,18,06, 26,10,10, 00,00,00 ; PAL_CHARMANDER
	RGB 31,31,31, 31,14,05, 23,09,10, 00,00,00 ; PAL_CHARMELEON
	RGB 31,31,31, 30,15,00, 08,18,20, 00,00,00 ; PAL_CHARIZARD
	RGB 31,31,31, 22,16,12, 15,24,28, 00,00,00 ; PAL_SQUIRTLE
	RGB 31,31,31, 22,19,14, 12,19,31, 00,00,00 ; PAL_WARTORTLE
	RGB 31,31,31, 22,19,14, 08,11,31, 00,00,00 ; PAL_BLASTOISE
	RGB 31,31,31, 12,22,10, 28,08,10, 00,00,00 ; PAL_CATERPIE
	...
	RGB 31,31,31, 31,27,01, 28,04,00, 00,00,00 ; PAL_PIKACHU
	RGB 31,31,31, 31,26,04, 31,16,06, 00,00,00 ; PAL_RAICHU
	...
	RGB 31,31,31, 20,14,10, 18,09,10, 00,00,00 ; PAL_DIGLETT
	RGB 31,31,31, 20,14,10, 18,09,10, 00,00,00 ; PAL_DUGTRIO
	...
	RGB 31,31,31, 28,26,06, 16,12,10, 00,00,00 ; PAL_ABRA
	RGB 31,31,31, 28,26,06, 16,12,10, 00,00,00 ; PAL_KADABRA
	RGB 31,31,31, 28,26,06, 16,12,10, 00,00,00 ; PAL_ALAKAZAM
	...
	RGB 31,31,31, 30,28,14, 30,10,06, 00,00,00 ; PAL_PONYTA
	RGB 31,31,31, 30,28,14, 30,10,06, 00,00,00 ; PAL_RAPIDASH
	...
	RGB 31,31,31, 20,14,10, 05,15,07, 00,00,00 ; PAL_EXEGGUTOR
	...
	RGB 31,31,31, 31,31,05, 24,20,00, 00,00,00 ; PAL_JOLTEON
	...
	RGB 31,31,31, 16,24,30, 08,14,20, 00,00,00 ; PAL_ARTICUNO
	...
	RGB 31,31,31, 30,22,26, 14,20,24, 00,00,00 ; PAL_MEW
	RGB 31,31,31, 28,20,16, 30,08,00, 00,00,00 ; PAL_YOUNGSTER
	...
	RGB 31,31,31, 28,22,18, 06,16,10, 00,00,00 ; PAL_JR_TRAINER_F
	...
	RGB 31,31,31, 28,22,18, 12,09,19, 00,00,00 ; PAL_GARY1
	...
	RGB 31,31,31, 28,22,18, 28,06,06, 00,00,00 ; PAL_HERO
ENDC
